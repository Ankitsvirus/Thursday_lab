...
public class ParameterizedConstructor {
	...
	public static void main(String[] args) {
		Book b =new Book("Book", "python", "A Brain-Friendly Guide", "science", 120);
		Book b1 =new Book("Book", "java", "E Balagurusamy", "fiction", 150);
		Book b2 =new Book("Book", "c++", " Bjarne Stroustrup", "technology", 180);
		b.display();
		b1.display();
		b2.display();
